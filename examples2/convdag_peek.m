classdef convdag_peek < handle
  %convdag_peek Observer that do printing, plotting stuff
  ...
  methods
    ...
    function save_mo(ob_this, ob, ~) % (ob_this, ob, evt)
      ...
      t = ob.cc.epoch_cnt;     
      fn_cur_mo = fullfile(...
        ob_this.dir_mo, sprintf('dag_epoch_%d.mat',t) );
      % check if it exists
